"""Legacy analytics endpoints (Phase 1-5).

These endpoints query raw_job_postings directly and predate the dbt analytics
layer.  They are preserved for backward-compatibility; Phase 6 endpoints live
in the sibling modules (trending_skills.py, salary_insights.py, etc.).
"""
...
router = APIRouter(tags=["analytics-legacy"])
