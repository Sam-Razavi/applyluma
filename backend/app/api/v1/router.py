...
from app.api.v1.endpoints.auth_github import router as auth_github_router
from app.api.v1.endpoints.auth_google import router as auth_google_router
from app.api.v1.endpoints.auth_linkedin import router as auth_linkedin_router
...
api_router.include_router(auth_linkedin_router)
api_router.include_router(auth_github_router)
