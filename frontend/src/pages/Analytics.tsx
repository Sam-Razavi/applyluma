          ...
          >
            {cvs.length > 0 && (
              <div className="mb-4 max-w-sm">
                <label htmlFor="analytics-resume" className="mb-1 block text-xs font-medium text-fg-muted">
                  Resume
                </label>
                <select
                  id="analytics-resume"
                  ...
                  className="w-full rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm text-fg shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-100"
                >
                  {cvs.map((cv) => (
