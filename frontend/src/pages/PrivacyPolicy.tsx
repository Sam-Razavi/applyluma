...
export default function PrivacyPolicy() {
  useEffect(() => {
    document.title = 'Privacy Policy — ApplyLuma'
  }, [])
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-fg-muted">
        ...
        <section>
          <h2 className="text-xl font-semibold text-fg mb-3">1. Who We Are</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-fg mb-3">2. Data We Collect</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-fg mb-3">3. How We Use Your Data</h2>
          <ul className="list-disc list-inside space-y-2">
        ...
        <section>
          <h2 className="text-xl font-semibold text-fg mb-3">4. Third-Party Services</h2>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>
              ...
              <code className="text-xs bg-surface px-1 rounded">access_token</code>,{' '}
              <code className="text-xs bg-surface px-1 rounded">refresh_token</code>) and a
