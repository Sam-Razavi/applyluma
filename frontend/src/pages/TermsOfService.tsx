export default function TermsOfService() {
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold text-white/90 mb-2">Terms of Service</h1>
      <p className="text-sm text-white/30 mb-10">Last updated: May 2026</p>

      <div className="prose prose-gray max-w-none space-y-8 text-white/55">

        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">1. Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">2. Description of Service</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">3. Account Registration</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">4. AI-Generated Content</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">5. Subscriptions and Billing</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">6. Acceptable Use</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">7. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">8. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">9. Termination</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">10. Changes to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">11. Governing Law</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white/90 mb-3">12. Contact</h2>
          <p>
