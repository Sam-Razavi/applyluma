        ...
        <div className="mt-4 space-y-5">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                {user?.role === 'premium' || user?.role === 'admin' ? (
                  ...
                  <span className="rounded-full border border-gray-200 bg-gray-50 px-3 py-0.5 text-xs font-semibold text-gray-600 dark:bg-gray-700 dark:text-gray-300">
                    Free
                  </span>
                )}
              </div>
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between">
              ...
              {loading || !usage ? (
                <span className="h-4 w-16 animate-pulse rounded bg-gray-100 dark:bg-gray-700" />
              ) : usage.daily_limit === null ? (
                <span className="text-xs font-semibold text-green-600">Unlimited</span>
              ) : (
                <span className={`text-xs font-semibold ${usage.used_today >= usage.daily_limit ? 'text-red-600' : 'text-gray-700 dark:text-gray-300'}`}>
