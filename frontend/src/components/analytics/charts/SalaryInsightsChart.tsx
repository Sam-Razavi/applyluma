    ...
    <>
      <div className="h-48 w-full md:h-72">
        <ResponsiveContainer width="100%" height="100%">
          ...
          <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="var(--track)" />
          <XAxis dataKey="category" angle={-35} textAnchor="end" height={72} tick={{ fontSize: 11, fill: 'var(--text-3)' }} interval={0} axisLine={{ stroke: 'var(--glass-border-strong)' }} tickLine={false} />
