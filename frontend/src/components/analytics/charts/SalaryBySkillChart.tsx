    ...
    <>
      <div className="h-48 w-full md:h-72">
        <ResponsiveContainer width="100%" height="100%">
          ...
          <XAxis type="number" tickFormatter={(value) => formatCompactCurrency(Number(value))} tick={{ fontSize: 12, fill: 'rgba(255,255,255,0.35)' }} axisLine={{ stroke: '#e5e7eb' }} tickLine={false} />
