    ...
    <>
      <div className="h-48 w-full md:h-72">
        <ResponsiveContainer width="100%" height="100%">
          ...
          <XAxis type="number" tickFormatter={(value) => formatCompactCurrency(Number(value))} tick={{ fontSize: 12, fill: 'var(--text-3)' }} axisLine={{ stroke: 'var(--glass-border-strong)' }} tickLine={false} />
