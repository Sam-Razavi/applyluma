...
export function TailorSummary({ meta }: Props) {
  return (
    <div className="grid grid-cols-1 gap-4 rounded-2xl border border-white/10 bg-white/[0.04] p-5 md:grid-cols-3">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-white/30">Intensity</p>
        <p className="mt-1 text-sm font-semibold capitalize text-white/90">
